...
\label{chap:design}
Tato kapitola se zaměřuje na návrh a implementaci nástroje pro monitorování velkých repozitářů, konkrétně se zaměříme na repozitář Rust překladače.

\input{chapters/practice/design/requirements.tex}
\input{chapters/practice/design/architecture.tex}
\input{chapters/practice/design/visualization.tex}
