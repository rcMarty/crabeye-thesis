...
Podrobný přehled jednotlivých fází je uveden v~\customref{Tabulce}{tab:evaluace:benchmarks:inicializace}.
...
\begin{table}[h]
  ...
  \begin{tabular}{lr}
    ...
    \midrule
    Klonování git repozitáře & $~$ 1 min 20 s \\
...
\customref{Výpis}{lst:evaluace:benchmarks:inkrementalni} zachycuje log inkrementální aktualizace v situaci, kdy nebyly nalezeny žádné nové záznamy.
...
GitHub omezuje počet \API požadavků na 5\,000 za hodinu pro autentizované požadavky~\cite{github_rate_limits} \subsectionref{subsec:github_api_limits}.
