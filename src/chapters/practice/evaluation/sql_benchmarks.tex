...
Byly testovány čtyři dotazy (S1--S4) pokrývající typické analytické scénáře. Dotazy jsou uvedeny v~příloze~\ref{chap:appendix:sql}. Stručný popis každého dotazu:
