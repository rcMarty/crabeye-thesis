...
\begin{enumerate}
  ...
  \item \textbf{Analytické zpracování}
    \begin{itemize}
      ...
      \item Systém musí poskytovat následující analytické pohledy \chapterref{chap:queries}:
        \begin{itemize}
          \item historický stav konkrétního \PR k~zadanému datu (rekonstrukce z~událostí a~změn štítků),
          \item počet \PR v~konkrétním stavu k~zadanému datu,
          \item vývoj počtu \PR v~konkrétním stavu v~čase,
          \item přehled \PR aktuálně čekajících na review nebo jiný přístup,
          \item události konkrétní issue k~zadanému datu,
          \item soubory nejčastěji upravované konkrétním přispěvatelem,
          \item přispěvatelé, kteří upravili daný soubor nebo složku,
          \item soubory upravené členy daného týmu v~zadaném časovém okně.
        \end{itemize}
    \end{itemize}
