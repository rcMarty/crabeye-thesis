...
Štítky a~události jsou rozděleny do oddělených tabulek z~důvodu malého průniku jejich atributů. Řešení je obdobné jako u~tabulky issues, kde jediným rozdílem mezi issue a~\PR je příznak určující typ záznamu. Štítky a~události mají řadu odlišných atributů, a~proto je vhodnější je uchovávat ve dvou samostatných tabulkách.
