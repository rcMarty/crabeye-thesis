...
Tato sekce popisuje, jakým způsobem jsou analytické dotazy definované v~\customref{Podsekci}{subsec:requirements:queries} realizovány. Pro každý dotaz je uvedeno, z~jakých datových zdrojů čerpá a~které tabulky databáze využívá.
