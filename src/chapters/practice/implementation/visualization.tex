...
Třetí vizualizací jsou soubory upravené členy daného týmu v~zadaném časovém okně, dostupné přes endpoint \code{/api/pr/files-modified-by-team}. Uživatel zadá název repozitáře, název týmu, kotevní datum a~počet dní pro zpětný pohled. Výsledkem je seznam souborů seřazený sestupně podle počtu úprav. Klíčovým parametrem je \code{group\_level}, který určuje způsob seskupení výsledků:
