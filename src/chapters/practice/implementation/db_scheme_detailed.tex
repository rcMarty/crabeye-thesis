...
\begin{description}
  ...
  \item[\code{merge\_sha}] Obsahuje hash commitu pouze u úspěšně sloučených (merged) pull requestů. Pokud je \PR stále otevřený nebo byl zahozen, zůstává hodnota \code{NULL}.
\end{description}
