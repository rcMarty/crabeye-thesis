...
GitHub nabízí základní nativní statistiky dostupné přímo v~záložce \textit{Insights} na stránce každého repozitáře. Zahrnují přehled otevřených a~zavřených \PR, aktivitu přispěvatelů a~další údaje.
